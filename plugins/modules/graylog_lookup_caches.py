...
import os
import sys
#sys.path.insert(0, os.path.expanduser('~/.virtualenvs/ansible/lib/python3.10/site-packages/'))
#sys.path.insert(0, os.path.expanduser('~/.virtualenvs/ansible/lib/python3.10/site-packages/ansible'))
#sys.path.insert(0, os.path.expanduser('~/.virtualenvs/ansible/lib/python3.10/site-packages/ansible/errors/'))
#import ansible
